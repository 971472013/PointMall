...
export default {
  ...
  methods: {
    seteditor() {
      ...
      this.editor.customConfig.uploadImgServer = '/api/admin/uploadImage'// 配置服务器端地址
      this.editor.customConfig.uploadImgHeaders = { token: this.$store.getters.token }// 自定义 header
